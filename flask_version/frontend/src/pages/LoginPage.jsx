    ...
    <div style={{ minHeight: "100vh", background: c.pageBg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', sans-serif", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420, padding: "40px 36px", borderRadius: 24, background: c.cardBg, border: `1px solid ${c.cardBorder}`, boxShadow: "0 8px 40px rgba(0,0,0,0.08)" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ margin: 0, fontSize: 26, color: c.headingMain, fontWeight: 600, fontFamily: "'Playfair Display', serif" }}>Welcome back</h1>
          <p style={{ marginTop: 6, fontSize: 13, color: c.mutedText }}>Log in to your TaskWise account</p>
        </div>

        {/* Google Login */}
        <button onClick={handleGoogleLogin} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: "11px", borderRadius: 10, border: `1.5px solid ${c.cardBorder}`, background: c.pageBg, color: c.bodyText, cursor: "pointer", fontSize: 14, fontWeight: 500, marginBottom: 20 }}>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ position: "relative" }}>
              <input className="auth-input" style={inputStyle} type={showPass ? "text" : "password"} placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required />
        ...
        <p style={{ textAlign: "center", marginTop: 20, fontSize: 13, color: c.mutedText }}>
          ...
          <Link to="/signup" style={{ color: c.accent, textDecoration: "none", fontWeight: 500 }}>Sign up</Link>
        </p>
